class Car {
    constructor(x, y, width, height, controlType, angle = 0, maxSpeed = 15, color = "red") {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        this.maxSpeed = maxSpeed; // Increased max speed
        this.friction = 0.03;     // Reduced friction
        this.angle = angle;
        this.damaged = false;

        this.fittness = 0;
        this.boosting = false;    // Boost state
    ...
    update(roadBorders, traffic) {
        ...
        if (this.sensor) {
            ...
            if (this.useBrain) {
                ...
                this.controls.boost = outputs[4]; // AI can use boost
            }
        }
    }
    ...
    #move() {
        ...
        if (this.controls.boost) {
            this.speed += this.acceleration * 2; // Double acceleration on boost
            this.maxSpeed = 25; // Increased speed limit during boost
        } else {
